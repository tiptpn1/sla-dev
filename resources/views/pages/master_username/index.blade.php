                    ...
                    success: function(data) {
                        ...
                        $.each(data.data, function(index, username) {
                            ...
                            var urlEdit = "{{ route('master-username.edit', ':Id') }}".replace(
                                ...
                                .master_bagian_id);
                            var row = `
                                <tr id="bagian-${username.master_bagian_id}">
                                    ...
                                    <td scope="row">
                                        <button class="btn btn-sm btn-edit" data-toggle="modal" data-target="#updateBagianModal" data-id="${username.kpi_master_bagian_id}">
                                            <i class="fas fa-edit"></i> Edit
                                        </button>
                                        <button type="submit" class="btn btn-sm btn-delete deleteButton" type="button" data-toggle="modal" data-id="${username.kpi_master_bagian_id}">

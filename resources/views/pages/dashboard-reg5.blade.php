...
@section('title', 'Dashboard Regional 5')
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select class="form-control" id="unit" name="unit">
                ...
                <option value="11" selected>Regional 5</option>
                              ...
                              <table id="table_b" class="table_data table table-bordered table-responsive">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>Peningkatan nilai penjualan produk teh premium kebun model Wonosari dibanding tahun 2023</td>
                                    <td>C</td>
                                    <td>-</td>
                                    <td>Rp. Miliar</td>
                                    <td>1,5</td>

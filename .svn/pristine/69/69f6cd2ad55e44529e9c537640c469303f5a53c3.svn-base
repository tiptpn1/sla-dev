...
@section('title', 'Dashboard Direktorat SDM dan TI')
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select class="form-control" id="unit" name="unit">
                ...
                <option value="4" selected>Direktorat SDM dan TI</option>
                            ...
                            <div class="container">
                              <table id="table_b" class="table_data table table-bordered table-responsive">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td>2</td>
                                    <td>Buku Rencana Strategis Teknologi Informasi 2025-2029</td>
                                    <td>"1. Buku Rencana Strategis Teknologi Informasi (70%)
                                      2. Penyampaian ke RUPS/KBUMN (30%)"</td>
                                    <td>C</td>
                                    <td>-</td>
                                    <td>%</td>
                                    <td>100</td>
